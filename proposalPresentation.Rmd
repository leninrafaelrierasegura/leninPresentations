...
### Preliminaries | Metric graphs | Example 1 (2D)
*********
...
### Preliminaries | Metric graphs | Example 2 (3D)
*********
...
### Preliminaries | Metric graphs | Example 3 (3D)
*********
...
To fix ideas, let $\alpha > \sfrac{1}{2}$, and consider the SPDE
\begin{align}
\label{eq:spde_on_graphgamma}
    (\kappa^2-\Delta_{\Gamma})^{\sfrac{\alpha}{2}}(\tau u) = \mathcal{W}, \quad\text{on }\Gamma.
\end{align}
