...
### Preliminaries | Metric graphs
*********

A metric graph $\Gamma$ is a combinatorial undirected graph $\Gamma = (\mathcal{V}, \mathcal{E})$ equipped with a metric $d(\cdot,\cdot)$, where $\mathcal{V} = \{v_i\}$ is a finite set of vertices and $\mathcal{E} = \{e_j\}$ is a set of undirected edges connecting pairs of vertices.
...
```{r, eval =TRUE, fig.height = 1.8, out.width = "50%", fig.cap = captioner("THANK-YOU-FOR-YOUR-ATTENTION graph.")}
# figures
